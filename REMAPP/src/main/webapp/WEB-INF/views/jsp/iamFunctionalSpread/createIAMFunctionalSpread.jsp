	...
	<div class="container"
		...
		<div class="panel panel-default">
			...
			<div class="panel-heading" style="background-color: #efe6f2">
				<span class="lead"> Add New Functional Spread </span>
			</div>
				...
				<div uib-accordion-group class="panel-default"
					...
					<div class="row col-md-12">
						...
						<div class="form-group col-md-6">
							...
							<div class="col-md-8">
								<ui-select ng-model="servicesDetails[$index].securityDomain"
									...
									ng-change="onSelectSecurityDomain(servicesDetails[$index].securityDomain,$index)">
						...
						<div class="form-group col-md-6">
							...
							<div class="col-md-8">
								<ui-select
									ng-model="servicesDetails[$index].serviceCategory.selected"
									theme="bootstrap" style="min-width: 300px;"
									class="btn-group bootstrap-select" append-to-body="true"
									search-enabled="true" ng-required="true"
									ng-change="onSelectServiceCategory(servicesDetails[$index].serviceCategory.selected,$index)">
					...
					<div class="row col-md-12">
						...
						<div class="form-group col-md-6">
							...
							<div class="col-md-8">
								<ui-select ng-model="servicesDetails[$index].service.selected"
									theme="bootstrap" style="min-width: 300px;"
									class="btn-group bootstrap-select" append-to-body="true"
									search-enabled="true" ng-required="true"
									ng-change="onSelectService(servicesDetails[$index].service.selected,$index)">
