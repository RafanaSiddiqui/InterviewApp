...
<div class="container" ng-controller="BotController as ctrl" ng-init="editBotById('${fn:escapeXml(botId)}')">
					...
					<div class="form-group col-md-6">
							...
							<div class="col-md-8">
								...
								<select class="form-control" name="competency"
									...
									ng-model="bot.competency" ng-select="bot.competency" required>
								</select>
						...
						<div class="form-group col-md-6">
							...
							<div class="col-md-4">
								...
								<select class="form-control" name="automationSolution"
									...
									ng-model="bot.automationSolution" ng-select="bot.automationSolution" required>
								</select>
							...
							<div class="col-md-4" ng-if="bot.automationSolution=='Others'">
								...
								<input type="text" ng-model="bot.automationSolutionActual"
