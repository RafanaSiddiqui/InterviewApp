...
<body ng-app="myApp" class="ng-cloak" ng-controller="BotMeasurementController as ctrl">
	<div class="container" ng-controller="BotMeasurementController as ctrl" ng-init="editBotMeasurementById('${botMeasurementId}')">
		<div class="panel panel-default">
			<!-- Default panel contents -->
			<div class="panel-heading" style="background-color: #efe6f2">
				<span class="lead"> Edit Bot Measurement</span>
			</div>
				...
				<form ng-submit="ctrl.submit()" name="myForm"
					...
					<div class="row col-md-12">
						<div class="form-group col-md-6">
							...
							<div class="col-md-8">
								<!-- <input type="text" ng-model="botMeasurement.botName"
								...
								<!-- <select class="form-control" name="botName"
									...
									ng-model="botMeasurement.botId" ng-select="botMeasurement.botId" required ng-change="onSelectBotName(botMeasurement.botId)">
								</select> -->
						...
						<div class="form-group col-md-6">
							...
							<div class="col-md-8">
								...
								<!-- <select class="form-control" name="competency"
									...
									ng-model="botMeasurement.competency" ng-select="botMeasurement.competency" required ng-disabled="true">
								</select> -->
						...
						<!-- <div class="form-group col-md-6">
							...
							<div class="col-md-8">
								<input type="text" ng-model="botMeasurement.automationSolution"
					...
					<div class="row col-md-12">
						<div class="form-group col-md-6">
							...
							<div class="col-md-8">
      									<input type="text" ng-model="botMeasurement.projectId"
						...
						<div class="form-group col-md-6">
							...
							<div class="col-md-8">
								<input type="text" ng-model="botMeasurement.projectName"
					...
					<div class="row col-md-12">
						<div class="form-group col-md-6">
							...
							<div class="col-md-8">
								<!-- <input type="text" ng-model="botMeasurement.customerName"
									name="customerName" class="form-control input-sm"
									placeholder="Enter Customer Name" required ng-minlength="3" /> -->
									
								<select class="form-control" name="customerName" ng-change="onSelectCustName(botMeasurement.customerName)"
									ng-options="accountBase.name as accountBase.name for accountBase in accountBaseList"
									ng-model="botMeasurement.customerName" ng-select="botMeasurement.customerName" required ng-disabled="true">
								</select>	
						...
						<div class="form-group col-md-6">
							...
							<div class="col-md-8">
								<input type="text" ng-model="botMeasurement.compManager"
					...
					<div class="row col-md-12">
						...
						<div class="form-group col-md-6">
							...
							<div class="col-md-8">
								<input type="month" ng-model="botMeasurement.createdMonth"
						...
						<div class="form-group col-md-6">
							...
							<div class="col-md-8">
								<input type="number" ng-model="botMeasurement.manualEffortBeforeBot"
					...
					<div class="row col-md-12">
						...
						<div class="form-group col-md-6">
							...
							<div class="col-md-8">
								<input type="number" ng-model="botMeasurement.manualEffortAfterBot"
						...
						<div class="form-group col-md-6">
							...
							<div class="col-md-8">
								<input type="number" ng-model="botMeasurement.noOfExecutions"
					...
					<div class="row col-md-12">
						...
						<div class="form-group col-md-6">
							...
							<div class="col-md-8">
								<input type="number" ng-model="botMeasurement.noOfFailures"
						...
						<div class="form-group col-md-6">
							...
							<div class="col-md-8">
							<input type="number" ng-model="botMeasurement.totalHrsSaved"
					...
					<div class="form-group col-md-6">
							...
							<div class="col-md-8">
							<input type="text" ng-model="botMeasurement.dataEnteredBy"
