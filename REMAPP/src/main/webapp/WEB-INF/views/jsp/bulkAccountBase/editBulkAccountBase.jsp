...
<body ng-app="myApp" class="ng-cloak">
	<div class="container" ng-controller="BulkAccountBaseController as ctrl" ng-init="editBulkAccountBaseById('${fn:escapeXml(bulkID)}')">
		<div class="panel panel-default">
			<!-- Default panel contents -->
			<div class="panel-heading" style="background-color: #efe6f2">
				<span class="lead"> Edit Bulk Account Base</span> <input type="hidden"
					ng-model="ctrl.bulkAccountBase.bulkID" value="{{bulkID}}" />
