...
<div class="container" ng-controller="AccountBaseController as ctrl" ng-init="editAccountBaseById('${fn:escapeXml(accountBaseId)}')">
		<div class="panel panel-default">
			<!-- Default panel contents -->
			<div class="panel-heading" style="background-color: #efe6f2">
				<span class="lead"> Edit Account Base </span>
			</div>
