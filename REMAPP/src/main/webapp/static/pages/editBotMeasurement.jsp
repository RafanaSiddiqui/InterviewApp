					...
					<div class="row col-md-12">
						<div class="form-group col-md-6">
							...
							<div class="col-md-8">
								...
								<select class="form-control" name="customerName" ng-change="onSelectCustName(ctrl.bot.customerName)"
									ng-options="custDetails.name as custDetails.name for custDetails in customerDetails"
									ng-model="botMeasurement.customerName" ng-select="botMeasurement.customerName" required>
								</select>	
